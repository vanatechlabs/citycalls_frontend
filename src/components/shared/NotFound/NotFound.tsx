  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link href="/" className="inline-flex rounded-full bg-primary text-primary-foreground hover:bg-primary-dark px-6 py-3 text-sm font-semibold transition-colors">
            Back to home
          </Link>
        </div>
      </div>
