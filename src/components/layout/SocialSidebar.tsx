...
const SocialSidebar = () => {
  ...
  const safeHref = (url: string) => (url?.trim() ? normalizeUrl(url) : "#");
    ...
    <>
      <style>{`
        ...
        .sidebar-glass {
          ...
          position: relative;
          overflow: hidden;
          animation: slideInGlass 0.7s cubic-bezier(0.16, 1, 0.3, 1) forwards;
        }
      ...
      <div
        className="hidden lg:block fixed right-2 top-1/2 z-50 sidebar-wrap"
          ...
          {socialData.map((social, i) => {
            ...
            return (
              <div
                ...
                style={{ "--i": i, "--glow": social.glow } as any}
