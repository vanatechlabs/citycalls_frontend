    ...
    <>
      <article className="bg-background">
        <div className="container-x pt-10 pb-4 max-w-3xl">
          <Link href="/blogs" className="inline-flex items-center gap-1 text-xs font-semibold text-muted-foreground hover:text-primary-dark">
      ...
      <section className="bg-muted/40">
        <div className="container-x py-16">
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-3">
            {related.map((b) => (
              <Link key={b.slug} href={`/blogs/${b.slug}`} className="group rounded-3xl overflow-hidden border border-border bg-card shadow-soft hover:shadow-elevate transition-all">
