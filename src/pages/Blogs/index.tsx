    ...
    <>
      <section ref={containerRef} className="relative text-white overflow-hidden bg-ink" style={{ perspective: "1000px" }}>
        <motion.div 
          ...
          style={{ 
            backgroundImage: `url('https://images.unsplash.com/photo-1455390582262-044cdead2708?q=80&w=2000&auto=format&fit=crop')`,
            y: bgY
          }}
        />
        ...
        <div className="container-x py-14">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {blogs.map((b, idx) => (
              ...
              >
                <Link to={`/blogs/${b.slug}`} className="flex flex-col h-full relative z-10">
